...
#define LOGD(format, ...)                                               \
  LJMP::Log::GetInstance()->Write(LJMP::Log::LogLevel::LOG_DEBUG_MESSAGE, "FILE:{}, FUNCTION:{},"##format, \
                            __FILE__, __FUNCTION__, ##__VA_ARGS__)
#define LOGE(format, ...)                                               \
  LJMP::Log::GetInstance()->Write(LJMP::Log::LogLevel::LOG_ERROR_MESSAGE, "FILE:{}, FUNCTION:{},"##format, \
                            __FILE__, __FUNCTION__, ##__VA_ARGS__)
#define LOGW(format, ...)                                               \
  LJMP::Log::GetInstance()->Write(LJMP::Log::LogLevel::LOG_WARNING_MESSAGE, "FILE:{}, FUNCTION:{},"##format, \
                            __FILE__, __FUNCTION__, ##__VA_ARGS__)
#define LOGI(format, ...)                                               \
  LJMP::Log::GetInstance()->Write(LJMP::Log::LogLevel::LOG_INFO_MESSAGE, "FILE:{}, FUNCTION:{},"##format, \
                            __FILE__, __FUNCTION__, ##__VA_ARGS__)
#define LOGC(format, ...)                                             \
